...
public class CandidateViewModel {
    ...
    private String expCertificateType;    
	...
	public CandidateViewModel(List<CandidateViewModel> sListt) {
	...
	public String getExpCertificateType() {
		return expCertificateType;
	}
	public void setExpCertificateType(String expCertificateType) {
		this.expCertificateType = expCertificateType;
	}
